...
import { userRedirect } from "../controller/auth";
...
router.get("/auth/signin", async function (req: any, res: any, next: any) {
   ...
   */
  const redirect_url = req.query.task_id
...
router.get("/acquireToken", async function (req: any, res: any, next: any) {
...
router.post("/auth/redirect", userRedirect);

router.get("/signout", function (req: any, res: any) {
  /**
